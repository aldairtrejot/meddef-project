package gob.hidalgo.curso.components.biblioteca;
...
import gob.hidalgo.curso.database.biblioteca.ArchivoEO;
import gob.hidalgo.curso.database.dominios.TiposObjetosDO;
